    ...
    <div className="min-h-[80vh] w-full flex flex-col items-center justify-center">
      ...
      <div className="md:w-[70%] min-w-fit max-w-[40em] text-[#292D32] grid">
        ...
        <div className="flex justify-between">
          <a href="/register" className="my-2 mx-4 font-bold underline sm:text-sm md:text-base">
            don't have an account, Sign Up
          </a>
          <a
            href="/reset/password"
            className="text-brandRed my-2 mx-4 text-right font-bold sm:text-sm md:text-base"
          >
            Reset Password
          </a>
        </div>
